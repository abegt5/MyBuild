...
const handleSignUp = async () => { // save username
  if (!username.trim()) {
...
const handleLogIn = async () => {
  ...
  return (
    ...
    {/* add something above signup form */}  

    <View className="flex-1 justify-center p-6 bg-white">
      <Tabs value={tab} onValueChange={(val) => setTab(val as 'signUp' | 'logIn')} className="w-full max-w-[400px] mx-auto">
       ...
       <TabsList className="flex-row w-full mb-4 bg-gray-100 rounded-lg p-1">
        <TabsTrigger
          ...
          <Text className={tab === 'signUp' ? 'text-white font-bold' : 'text-black'}>Sign Up</Text>
        ...
        >
          <Text className={tab === 'logIn' ? 'text-white font-bold' : 'text-black'}>Log In</Text>
        </TabsTrigger>
    </TabsList>
            ...
            <CardContent className="gap-4 native:gap-2">
              ...
              <View className="gap-1">
                ...
                <Input
                  ...
                  placeholder="********"
                  value={password}
                  onChangeText={setPassword} // firebase handles checking password
                  secureTextEntry
                />
              </View>
        ...
        <TabsContent value="logIn">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Access your account using email and password.</CardDescription>
            </CardHeader>
            <CardContent className="gap-4 native:gap-2">
              <View className="gap-1">
                <Label nativeID="email">Email</Label>
